...
;; Then Design a function that consumes a list of boolean values and produces
;; true if every value in the list is true. If the list is empty, your function 
...
(define LOB4 (cons #true (cons #false (cons #true empty))))
...
;; prouce true for empty list and if all value of the list is true
